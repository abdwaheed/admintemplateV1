...
const Teacher = React.lazy(() => import('./views/teacher/Teacher.js'))
const Student = React.lazy(() => import('./views/student/Student.js'))
// const Manage = React.lazy(() => import('./views/manage/Manage.js'))
const Courses = React.lazy(() => import('./views/courses/Courses.js'))
const Certification = React.lazy(() => import('./views/certification/Certification.js'))
...
const routes = [
  ...
  { path: '/teacher', name: 'Teacher Page', component: Teacher },
  { path: '/student', name: 'Student Page', component: Student },
